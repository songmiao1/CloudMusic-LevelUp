...
try:
    ...
    if code2 == 200:
        ...
        log.warning("云贝签到: 失败 " + str(js))
except Exception as e:
    log.error("云贝签到异常: " + str(e))

# VIP签到
url2 = "https://music.163.com/weapi/point/vipDailyTask"
try:
    data = {"csrf_token": csrf}
    r = s.post(url2, data=data, timeout=30)
    js = r.json() if r.status_code == 200 else {}
    code2 = js.get("code", -1)
    if code2 == 200:
        log.info("VIP签到: 成功")
        ...
        log.warning("VIP签到: 失败 " + str(js))
except Exception as e:
    log.error("VIP签到异常: " + str(e))
